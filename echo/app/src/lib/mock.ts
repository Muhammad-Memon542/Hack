...
export const subjects: Subject[] = [
  {
    ...
    avatar: "🛹",
    color: "#a78bfa",
    bio: "Sends every stunt, films every fail. If there's a dare, he already said yes. Verified subject on Better.",
    verified: true,
    optOut: false,
    totalYieldEarned: 45.2,
    marketCount: 3,
    socials: [
      { label: "twitter", href: "https://x.com/deshawnsendit" },
      { label: "instagram", href: "https://instagram.com/deshawnsendit" },
    ],
    aboutAccuracy: 0.71,
  },
  {
    ...
    slug: "mayor-green",
    name: "Councilwoman Vance",
    avatar: "🏛️",
    color: "#4ade80",
    bio: "District councilwoman. Markets about civic promises and the potholes that keep outliving them.",
    verified: true,
    optOut: false,
...
export const markets: Market[] = [
  {
    id: "m_backflip",
    question: "Will Deshawn land the backflip at Saturday's cookout?",
    description:
      "Resolves YES if Deshawn lands a standing backflip on his feet — no hands down — filmed by at least two people at the cookout. Bailing, hands, or a fresh 'my knee' excuse resolves NO.",
  ...
  {
    id: "m_bikelane",
    question: "Will the city actually open the Main St bike lane before August?",
    description:
      "Resolves YES if the Main St protected bike lane is officially open to the public on or before July 31, 2026, per the city calendar. A 'soft launch' with cones and a ribbon does not count.",
  ...
  {
    id: "m_dj_set",
    question: "Will DJ Marlo actually show up to the block party this time?",
    description:
      "Resolves YES if DJ Marlo plays a set of at least 30 minutes at Friday's block party. Last time he ghosted for a 'flat tire,' so this stays open until the speakers are actually on.",
  ...
  {
    id: "m_coach_win",
    question: "Will Coach Dee's squad blow another 4th-quarter lead in the final?",
    description:
      "Resolves YES if the Eastside squad wins the final outright (OT counts, ties resolve NO). They've folded late all season, so YES is basically betting the collapse doesn't happen again.",
    creatorId: "u_demo_maker",
  ...
  {
    id: "m_farmers",
    question: "Will the farmers market sell out of matcha before 10am?",
    description:
      "Resolves YES if every matcha vendor is sold out before 10:00am Saturday, confirmed by two shoppers. Currently DISPUTED because nobody can agree whether oat-milk matcha counts.",
    creatorId: "u_park_ranger",
    subjectWallet: null,
    status: "DISPUTED",
    closesAt: daysAgo(1),
  ...
  {
    id: "m_marathon",
    question: "Did Oracle Queen actually run the 10k, or just post the medal?",
    description:
      "Resolved YES: official chip time was 48:31 on the results page. For once the medal selfie was earned.",
    creatorId: "u_coach_dee",
  ...
  {
    id: "m_amir_kickflip",
    question: "Will Deshawn film the library 5-stair kickflip before his knee quits?",
    description:
      "Resolves YES if Deshawn lands a clean kickflip down the library 5-stair on video before July 31. 'Almost had it' clips do not count.",
    creatorId: "u_demo_maker",
    subjectWallet: "Am1rXk4p9QhLandBackF1ipMeetupSo1anaW4LLet77",
    status: "OPEN",
  ...
  {
    id: "m_mayor_promise",
    question: "Did Councilwoman Vance keep the 'potholes fixed by July' promise?",
    description:
      "Resolved NO: three craters on Main St survived the entire month. RIP to everyone's wheel alignment.",
    creatorId: "u_park_ranger",
    subjectWallet: "M4y0rGr33nP4rkD1str1ctLoc4lEventSo1anaW4L88",
    status: "SETTLED",
    closesAt: daysAgo(3),
  ...
  {
    id: "m_cycling",
    question: "Will the run club hit 500 miles this week, or just show up for the pastries?",
    description:
      "Resolves YES if the club's combined Strava mileage reaches 500 by Sunday night. Coffee-shop 'recovery rides' still count as long as somebody logged them.",
  ...
  {
    id: "m_foodtruck",
    question: "Will the birria truck come back to the park this week?",
    description:
      "Resolves YES if the birria truck parks at the plaza any day this week, verified by a photo (bonus points if it comes with a taco).",
  ...
  {
    id: "m_startup",
    question: "Did the AI startup's live demo crash on stage again?",
    description:
      "Resolves YES if the demo visibly broke during the live pitch — spinner of death, wrong output, or a heartfelt 'it works on my machine' — per two attendees.",
    creatorId: "u_demo_maker",
    subjectWallet: null,
    status: "RESOLVING",
  ...
  },
  {
    ...
    description:
      "Resolves YES if SOL/USD trades at or above $200 on a major exchange before Aug 1, 2026. Copium is not an accepted resolution source.",
  ...
  {
    id: "m_priya",
    question: "Did Dana actually break 4 hours at the city marathon?",
    description:
      "Resolved YES: official chip time was 3:52:10. The 6-month training montage in the group chat finally paid off.",
  ...
  {
    id: "m_chug",
    question: "Will Muhammad be able to chug the can in 30s",
    description: "Resolve YES if he finishes under 30s",
    creatorId: "u_you",
    subjectWallet: null,
    status: "SETTLED",
    closesAt: "2026-07-19T06:33:00Z",
    resolvedAt: "2026-07-19T06:33:30Z",
    outcome: "YES",
    yesPool: 404,
    noPool: 1236,
    commentCount: 0,
...
export const comments: Comment[] = [
  { id: "c1", marketId: "m_backflip", userId: "u_park_ranger", parentId: null, content: "He landed it twice at the park Tuesday. Deshawn's sending it — YES all day.", createdAt: hoursAgo(1), tipsReceived: 2.5 },
  { id: "c2", marketId: "m_backflip", userId: "u_night_owl", parentId: "c1", content: "Practice ≠ a crowd with phones out. He always bails the second it counts.", createdAt: hoursAgo(0.8), tipsReceived: 0 },
  { id: "c3", marketId: "m_backflip", userId: "u_demo_maker", parentId: "c2", content: "Counterpoint: Deshawn is 90% ego. The crowd is literally his fuel.", createdAt: hoursAgo(0.5), tipsReceived: 1 },
  { id: "c4", marketId: "m_backflip", userId: "u_you", parentId: null, content: "Weather's dry Saturday, so there goes the 'wet grass' excuse.", createdAt: hoursAgo(0.3), tipsReceived: 0 },
  { id: "c5", marketId: "m_bikelane", userId: "u_oracle_queen", parentId: null, content: "Permits still haven't cleared. Zero chance that lane opens before August.", createdAt: hoursAgo(5), tipsReceived: 4 },
];
...
export const notifications: AppNotification[] = [
  {
    ...
    text: "@demo_maker created: Will Deshawn film the library 5-stair kickflip before his knee quits?",
  ...
  },
  {
    ...
    marketId: "m_backflip",
    text: "@park_ranger bet YES on Will Deshawn land the backflip at Saturday's cookout?",
  ...
  },
  {
    ...
    actorIds: [],
    marketId: "m_marathon",
    text: "Resolved YES: Did Oracle Queen actually run the 10k, or just post the medal? Claim your winnings.",
